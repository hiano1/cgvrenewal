			...
			<section class="mov_box">
				...
				<div class="mov_container">
					...
					<div class="bottom-info">
						<a class="btn btn-min-w btn-web btn-s"
							href="${root}/ticket/main?mnum=${movie_detail.mv_num}"
							role="button">영 화 예 매 </a>
					</div>
					<iframe class="btn btn-min-w btn-grey " id="mov_tr" width="1000"
						height="450" src="${movie_detail.mv_tr}" frameborder="0"
